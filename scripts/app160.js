...
$(function () {
    $("#button3").dxButton({
        ...
        onClick: async function () {
            ...
            try {
                var demouldedObjects6 = await API.viewer.getObjects({ parameter: { properties: { ["Default.GUID"]: { guidsDemouldedElements } } } });
                debugInfo = debugInfo.concat("<br />demouldedObjects6 count: " + demouldedObjects6.length);
                $(debug).html(debugInfo);
                debugInfo = debugInfo.concat("<br />demouldedObjects6[0].objects count: " + demouldedObjects6[0].objects.length);
                $(debug).html(debugInfo);
            }
            catch
            {
            ...
            try {
                var demouldedObjects7 = await API.viewer.getObjects({ parameter: { properties: { "Default.GUID": { guidsDemouldedElements } } } });
                debugInfo = debugInfo.concat("<br />demouldedObjects7 count: " + demouldedObjects7.length);
                $(debug).html(debugInfo);
                debugInfo = debugInfo.concat("<br />demouldedObjects7[0].objects count: " + demouldedObjects7[0].objects.length);
                $(debug).html(debugInfo);
            }
            catch
            {
            ...
            try {
                var demouldedObjects8 = await API.viewer.getObjects({ properties: { "Default.GUID": { guidsDemouldedElements } } });
                debugInfo = debugInfo.concat("<br />demouldedObjects8 count: " + demouldedObjects8.length);
                $(debug).html(debugInfo);
                debugInfo = debugInfo.concat("<br />demouldedObjects8[0].objects count: " + demouldedObjects8[0].objects.length);
                $(debug).html(debugInfo);
            }
            catch
            {
