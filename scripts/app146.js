...
$(function () {
    $("#button3").dxButton({
        ...
        onClick: async function () {
            ...
            debugInfo = debugInfo.concat("\nAll objects count: " + allObjects.length);
            $(debug).html(debugInfo); 
            ...
            debugInfo = debugInfo.concat("\ndemouldedObjects4 count: " + demouldedObjects4.length);
            $(debug).html(debugInfo);
