...
async function addTextMarkups() {
    try {
        ...
        var jsonArray = "[";
        SetText2(jsonArray);
        var propSelector = getPropSelector();
        ...
        for (var mobjects of mobjectsArr) {
            ...
            const objPropertiesArr = await API.viewer.getObjectProperties(mobjects.modelId, objectsRuntimeIds);
            for (var objproperties of objPropertiesArr) {
