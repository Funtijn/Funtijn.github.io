...
$(function () {
    $("#button3").dxButton({
        ...
        onClick: async function () {
            ...
            debugInfo = debugInfo.concat("\Project name: " + projectNumber);
            $(debug).html(debugInfo); 
                    ...
                    for (const record of data) {
                        ...
                        if (resultDateDemouled != null) {
                            ...
                            if (dateDemoulded < now) {
                                debugInfo = debugInfo.concat("<br />GUID_ENDED_ELE: " + record.name);
                                $(debug).html(debugInfo); 
            ...
            $(debug).html(debugInfo);
            debugInfo = debugInfo.concat("<br />All objects[0] count: " + allObjects[0].length);
            $(debug).html(debugInfo); 
            ...
            try {
                ...
                $(debug).html(debugInfo);
                debugInfo = debugInfo.concat("<br />demouldedObjects1[0] count: " + demouldedObjects1[0].length);
                $(debug).html(debugInfo); 
            }
            catch
            {
            ...
            try {
                var demouldedObjects2 = await API.viewer.getObjects({ parameter: { properties: { "GUID": guidsDemouldedElements } } });
                debugInfo = debugInfo.concat("<br />demouldedObjects2 count: " + demouldedObjects2.length);
                $(debug).html(debugInfo);
                debugInfo = debugInfo.concat("<br />demouldedObjects2[0] count: " + demouldedObjects2[0].length);
                $(debug).html(debugInfo); 
            }
            catch
            {
            ...
            //var demouldedObjects3 = await API.viewer.getObjects(parameter: { properties: { "GUID": guidsDemouldedElements } });
            //debugInfo = debugInfo.concat("\ndemouldedObjects3 count: " + demouldedObjects3.length);
            //$(debug).html(debugInfo);
            try {
                var demouldedObjects4 = await API.viewer.getObjects({ properties: { "GUID": guidsDemouldedElements } });
                debugInfo = debugInfo.concat("<br />demouldedObjects4 count: " + demouldedObjects4.length);
                $(debug).html(debugInfo);
                debugInfo = debugInfo.concat("<br />demouldedObjects4[0] count: " + demouldedObjects4[0].length);
                $(debug).html(debugInfo); 
            }
            catch
            {
            ...
            //var demouldedObjects5 = await API.viewer.getObjects(properties: { "GUID": guidsDemouldedElements });
            //debugInfo = debugInfo.concat("\ndemouldedObjects5 count: " + demouldedObjects5.length);
            //$(debug).html(debugInfo); 
            ...
            try {
                ...
                var demouldedObjectIds = [];
                debugInfo = debugInfo.concat("mobjectsArr length: " + mobjectsArr.length);
                $(debug).html(debugInfo);
