        ...
        for (const mobjects of mobjectsArr) {
            ...
            //for (var objproperties of mobjects.objects) {
                ...
                for (const propertyset of objproperties.properties) {
                    ...
                    const setName = propertyset.set;
                    if (typeof setName === "undefined") {
                        jsonArray = jsonArray.concat("value for property.set was undefined");
                    }
                    else {
                    ...
                    for (const property of propertyset.properties) {
                        ...
                        if (typeof propertyName !== "undefined") {
                            jsonArray = jsonArray.concat("<br /> name: ");
                            jsonArray = jsonArray.concat(propertyName);
                        }
                        const propertyValue = property.value;
                        if (typeof propertyValue !== "undefined") {
                            jsonArray = jsonArray.concat("<br /> value: ");
                            jsonArray = jsonArray.concat(propertyValue);
                        }
                        jsonArray = jsonArray.concat("<br /> -------- ");
                    }
                }
                ...
                //    for (const property2 of propertyArray) {
                //        jsonArray = jsonArray.concat("<br /> property: ");
                //        jsonArray = jsonArray.concat(property2.name);
                //    }
                //}
