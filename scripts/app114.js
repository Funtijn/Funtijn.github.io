...
$(function () {
    $("#button").dxButton({
        ...
        onClick: function () {
            ...
            setObjectsByPropnameAndValue("Default.MERKPREFIX", "K");
        },
    });
});
...
async function setObjectsByPropnameAndValue(propNameFilter, propValueFilter) {
    SetText("setObjectsByProp2");
    await API.viewer.setSelection(getPropSelectorByPropnameAndValue(propNameFilter, propValueFilter), "set");
}
